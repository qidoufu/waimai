    ...
    c.fn.fullpage = function(d) {
        function La() {
            ...
            d.anchors.length || (d.anchors =
                c("[data-anchor]").map(function() { return c(this).data("anchor").toString() }).get());
            ...
            la();
            if (!d.animateAnchor && (a = l.location.hash.replace("#", "").split("/")[0], a.length)) { var b = c('[data-anchor="' + a + '"]');
        ...
        function Oa(a, b, g) {
            ...
            b.each(function(a) { c(this).css("width", e + "%");
        ...
        function Na() { c(d.sectionSelector).each(function() { c(this).addClass("fp-section") });
        ...
        function Pa() {
            ...
            var a = c("#fp-nav");
            a.addClass(function() { return d.showActiveTooltip ? "fp-show-active " + d.navigationPosition : d.navigationPosition });
        ...
        function ja() { c(".fp-section").each(function() { var a = c(this).find(".fp-slide");
                a.length ? a.each(function() { J(c(this)) }) : J(c(this)) });
            ka() }
        ...
        function oa() {
            var a;
            if (!d.autoScrolling || d.scrollBar) { for (var b = n.scrollTop(), g = 0, f = p.abs(b - m.querySelectorAll(".fp-section")[0].offsetTop), h = m.querySelectorAll(".fp-section"), k = 0; k < h.length; ++k) { var l = p.abs(b - h[k].offsetTop);
                    l < f && (g = k, f = l) }
                a = c(h).eq(g) }
        ...
        function pa(a) { return a.find(".fp-slides").length ? a.find(".fp-slide.active").find(".fp-scrollable") : a.find(".fp-scrollable") }
        ...
        function Sa(a) { var b = a.originalEvent; if (!qa(a.target) && ba(b)) { d.autoScrolling && a.preventDefault();
                a = c(".fp-section.active"); var g = pa(a);
        ...
        function ba(a) { return "undefined" === typeof a.pointerType || "mouse" != a.pointerType }

        function Ta(a) { a = a.originalEvent;
            d.fitToSection && t.stop();
            ba(a) && (a = ra(a), E = a.y, N = a.x) }

        function sa(a, b) { for (var d = 0, c = a.slice(p.max(a.length - b, 1)), e = 0; e < c.length; e++) d += c[e]; return p.ceil(d / b) }
        ...
        function ua(a) {
            ...
            if (!(!b.length || z || 2 > g)) {
                var g = b.find(".fp-slide.active"),
                    ...
                    g.next(".fp-slide");
                if (!f.length) { if (!d.loopHorizontal) return;
        ...
        function va() { c(".fp-slide.active").each(function() { U(c(this), "internal") }) }
            ...
            requestAnimFrame(function() {
                ...
                if ("undefined" !== typeof f) {
                    ...
                    if (!(f.activeSection.is(a) && !v || d.scrollBar && n.scrollTop() === f.dtop && !a.hasClass("fp-auto-height"))) {
                        ...
                        if (c.isFunction(d.onLeave) && !f.localIsResizing) { if (!1 === d.onLeave.call(f.activeSection, f.leavingSection, f.sectionIndex + 1, f.yMovement)) return;
                            Ua(f.activeSection) }
        ...
        function Va(a) { if (d.css3 && d.autoScrolling && !d.scrollBar) wa("translate3d(0px, -" + a.dtop + "px, 0px)", !0), d.scrollingSpeed ? ca = setTimeout(function() { da(a) }, d.scrollingSpeed) : da(a);
            else { var b = Wa(a);
                c(b.element).animate(b.options, d.scrollingSpeed, d.easing).promise().done(function() { da(a) }) } }
        ...
        function da(a) { a.wrapAroundElements && a.wrapAroundElements.length && (a.isMovementUp ? c(".fp-section:first").before(a.wrapAroundElements) : c(".fp-section:last").after(a.wrapAroundElements), x(c(".fp-section.active").position().top), va());
        ...
        function K(a) { var b = a.find(".fp-slide.active");
            b.length && (a = c(b));
            a.find("img[data-src], source[data-src], audio[data-src]").each(function() { c(this).attr("src", c(this).data("src"));
                c(this).removeAttr("data-src");
                c(this).is("source") && c(this).closest("video").get(0).load() }) }

        function na(a) { a.find("video, audio").each(function() { var a = c(this).get(0);
        ...
        function xa() { if (!W && !d.lockAnchors) { var a = l.location.hash.replace("#", "").split("/"),
                    b = a[0],
                    a = a[1]; if (b.length) { var c = "undefined" === typeof A,
                        f = "undefined" === typeof A && "undefined" === typeof a && !z;
                    (b && b !== A && !c || f || !z && ea != a) && V(b, a) } } }

        function Xa(a) { y && (a.pageY < P ? e.moveSectionUp() : a.pageY > P && e.moveSectionDown());
            P = a.pageY }
        ...
        function F(a, b) {
            var g = b.position(),
                ...
                m = ya(b),
                n = v;
            if (d.onSlideLeave) { var r = e.find(".fp-slide.active"),
                    q = r.index(),
                    t;
                t = q == f ? "none" : q > f ? "left" : "right"; if (!n && "none" !== t && c.isFunction(d.onSlideLeave) && !1 === d.onSlideLeave.call(r, k, h + 1, q, t, f)) { z = !1; return } }
            ...
            d.css3 ? (g = "translate3d(-" + p.round(g.left) + "px, 0px, 0px)", za(a.find(".fp-slidesContainer"), 0 < d.scrollingSpeed).css(Aa(g)), fa = setTimeout(function() { u() }, d.scrollingSpeed, d.easing)) : a.animate({ scrollLeft: p.round(g.left) }, d.scrollingSpeed, d.easing, function() { u() });
        ...
        function la() { var a = d.responsive || d.responsiveWidth,
                b = d.responsiveHeight;
            a && e.setResponsive(n.width() < a);
            b && (h.hasClass("fp-responsive") || e.setResponsive(n.height() < b)) }

        function za(a) { var b = "all " + d.scrollingSpeed + "ms " + d.easingcss3;
            a.removeClass("fp-notransition"); return a.css({ "-webkit-transition": b, transition: b }) }
        ...
        function I(a, b) { d.menu && (c(d.menu).find(".active").removeClass("active"), c(d.menu).find('[data-menuanchor="' + a + '"]').addClass("active"));
        ...
        function J(a) {
            ...
            f > b ? c.length ? c.css("height", b + "px").parent().css("height", b + "px") : (d.verticalCentered ? a.find(".fp-tableCell").wrapInner('<div class="fp-scrollable" />') : a.wrapInner('<div class="fp-scrollable" />'),
                a.find(".fp-scrollable").slimScroll({ allowPageScroll: !0, height: b + "px", size: "10px", alwaysVisible: !0 })) : Ca(a);
            a.css("overflow", "")
        }

        function Ca(a) { a.find(".fp-scrollable").children().first().unwrap().unwrap();
            a.find(".slimScrollBar").remove();
            a.find(".slimScrollRail").remove() }

        function ia(a) { a.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:' + Da(a) + 'px;" />') }
        ...
        function wa(a, b) { b ? za(h) : h.addClass("fp-notransition");
            h.css(Aa(a));
            setTimeout(function() { h.removeClass("fp-notransition") }, 10) }

        function Ea(a) { var b = c('.fp-section[data-anchor="' + a + '"]');
            b.length || (b = c(".fp-section").eq(a - 1)); return b }

        function V(a, b) { var d = Ea(a); "undefined" === typeof b && (b = 0);
        ...
        function Ra(a, b) { a.append('<div class="fp-slidesNav"><ul></ul></div>'); var c = a.find(".fp-slidesNav");
            c.addClass(d.slidesNavPosition); for (var f = 0; f < b; f++) c.find("ul").append('<li><a href="#"><span></span></a></li>');
        ...
        function Ga(a) { if (d.recordHistory) location.hash = a;
            else if (Q || R) history.replaceState(H, H, "#" + a);
            else { var b = l.location.href.split("#")[0];
                l.location.replace(b + "#" + a) } }

        function ya(a) { var b = a.data("anchor");
            a = a.index(); "undefined" === typeof b && (b = a); return b }
        ...
        function $a() { if (Q || R) { var a = Ha();
                c(".fullpage-wrapper").off("touchstart " + a.down);
                c(".fullpage-wrapper").off("touchmove " + a.move) } }

        function Ha() { return l.PointerEvent ? { down: "pointerdown", move: "pointermove" } : { down: "MSPointerDown", move: "MSPointerMove" } }
        ...
        function U(a, b) { e.setScrollingSpeed(0, "internal"); "undefined" !== typeof b && (v = !0);
            F(a.closest(".fp-slides"), a); "undefined" !== typeof b && (v = !1);
        ...
        function Aa(a) { return { "-webkit-transform": a, "-moz-transform": a, "-ms-transform": a, transform: a } }

        function Ia(a, b, c) { switch (b) {
                case "up":
                    k[c].up = a; break;
                case "down":
                    k[c].down = a; break;
        ...
        function ab() {
            ...
            c.each(r.get(0).className.split(/\s+/), function(a, b) { 0 === b.indexOf("fp-viewing") && r.removeClass(b) });
            c(".fp-section, .fp-slide").each(function() { Ca(c(this));
                c(this).removeClass("fp-table active") });
            h.addClass("fp-notransition");
            h.find(".fp-tableCell, .fp-slidesContainer, .fp-slides").each(function() { c(this).replaceWith(this.childNodes) });
            t.scrollTop(0)
        }

        function S(a,
            b, c) { d[a] = b; "internal" !== c && (G[a] = b) }
        ...
        e.setKeyboardScrolling = function(a, b) { "undefined" !== typeof b ? (b = b.replace(/ /g, "").split(","), c.each(b, function(b, c) { Ia(a, c, "k") })) : d.keyboardScrolling = a };
        e.moveSectionUp = function() { var a = c(".fp-section.active").prev(".fp-section");
        ...
        e.silentMoveTo = function(a, b) { requestAnimFrame(function() { e.setScrollingSpeed(0, "internal") });
            e.moveTo(a, b);
            requestAnimFrame(function() { e.setScrollingSpeed(G.scrollingSpeed, "internal") }) };
        e.moveTo = function(a, b) { var c = Ea(a); "undefined" !== typeof b ? V(a, b) : 0 < c.length && B(c) };
        e.moveSlideRight = function() { ua("next") };
        e.moveSlideLeft = function() { ua("prev") };
        ...
        var z = !1,
            ...
            A, ea, y = !0,
            C = [],
            O, k = { m: { up: !0, down: !0, left: !0, right: !0 } };
        k.k = c.extend(!0, {}, k.m);
        var G = c.extend(!0, {}, d),
            ha, ca, fa, Z, aa, Ka;
        c(this).length && La();
        ...
        var E = 0,
            ...
            M = 0,
            ta = (new Date).getTime();
        l.requestAnimFrame = function() { return l.requestAnimationFrame || function(a) { a() } }();
        n.on("hashchange", xa);
        w.keydown(function(a) {
            clearTimeout(Ka);
            var b = c(":focus");
            b.is("textarea") ||
                b.is("input") || b.is("select") || !d.keyboardScrolling || !d.autoScrolling || (-1 < c.inArray(a.which, [40, 38, 32, 33, 34]) && a.preventDefault(), O = a.ctrlKey, Ka = setTimeout(function() { var b = a.shiftKey; switch (a.which) {
                            case 38:
                            case 33:
                                k.k.up && e.moveSectionUp(); break;
                            case 32:
                                if (b && k.k.up) { e.moveSectionUp(); break }
                            case 40:
                            case 34:
                                k.k.down && e.moveSectionDown(); break;
                            case 36:
                                k.k.up && e.moveTo(1); break;
                            case 35:
                                k.k.down && e.moveTo(c(".fp-section").length); break;
                            case 37:
                                k.k.left && e.moveSlideLeft(); break;
                            case 39:
                                k.k.right && e.moveSlideRight() } },
                    150))
        });
        w.keyup(function(a) { Ja && (O = a.ctrlKey) });
        c(l).blur(function() { O = Ja = !1 });
        h.mousedown(function(a) { 2 == a.which && (P = a.pageY, h.on("mousemove", Xa)) });
        h.mouseup(function(a) { 2 == a.which && h.off("mousemove") });
        var P = 0;
        w.on("click touchstart", "#fp-nav a", function(a) { a.preventDefault();
        ...
        d.normalScrollElements && (w.on("mouseenter", d.normalScrollElements, function() { e.setMouseWheelScrolling(!1) }), w.on("mouseleave", d.normalScrollElements, function() { e.setMouseWheelScrolling(!0) }));
        c(".fp-section").on("click touchstart", ".fp-controlArrow", function() { c(this).hasClass("fp-prev") ? k.m.left && e.moveSlideLeft() : k.m.right && e.moveSlideRight() });
        n.resize(Ba);
        var ga = q;
